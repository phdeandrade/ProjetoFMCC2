...
function addEquation() {
    ...
    newRow.innerHTML = `
        <input type="text" class="eq-input" placeholder="2x + 1" aria-label="Expressão da equação (exemplo: 2x + 1)">
        ≡ <input type="text" class="num-input" placeholder="2" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9-]/g, '')" aria-label="Resultado da congruência"> 
        (mod <input type="text" class="num-input" placeholder="5" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '')" aria-label="Módulo">)
